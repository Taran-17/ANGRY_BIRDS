...
public class GameScreen3 implements Screen {
    ...
    private final Sprite birdSprite, pigSprite, slingshotSprite, woodBlock1Sprite, woodBlock2Sprite, woodBlock3Sprite, woodBlock4Sprite, bgSprite;
    private final Stage stage;
    private final Skin skin;

    public GameScreen3(MyAngryBirds game) {
        this.game = game;
        ...
        woodBlock4Sprite = new Sprite(woodBlockTexture);
        ...
        woodBlock1Sprite.setSize(200, 120);
        woodBlock2Sprite.setSize(150, 150);
        woodBlock3Sprite.setSize(100, 130);
        woodBlock4Sprite.setSize(130, 180);
    ...
    private void initPositions() {
        ...
        woodBlock2Sprite.setPosition(1000, baseY + woodBlock1Sprite.getHeight() - 50);  // Overlap by 50 pixels
        ...
        woodBlock4Sprite.setPosition(800, baseY + woodBlock1Sprite.getHeight() );
    ...
    private void setupUI() {
        ...
        settingsButton.addListener(new ClickListener() {
            ...
            public void clicked(InputEvent event, float x, float y) {
                game.setScreen(new SettingsScreen(game, GameScreen3.this));
            }
        });
